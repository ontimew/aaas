...
export default function Hero({ setCurrentView }: HeroProps) {
  return (
    <section className="relative pt-40 pb-20 px-4 min-h-[75vh] flex items-center justify-center overflow-hidden">
      {/* Subtle Background Glows */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-violet-600/10 blur-[100px] md:blur-[140px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.p
          ...
          className="text-base md:text-xl text-white/50 font-medium mb-10 max-w-2xl mx-auto leading-relaxed md:leading-snug text-balance"
        >
          Um espaço seguro para projetos e apoio. Matchmaking de companhia e compras supervisionados
        </motion.p>
